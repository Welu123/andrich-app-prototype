...
import { Bus, ArrowRight, User, Users, Calendar, Smartphone, QrCode, CreditCard, CheckCircle, ChevronLeft, Minus, Plus, Ticket } from 'lucide-react';
...
const HomeScreen = ({ onBack, passengerName, setPassengerName, departure, setDeparture, arrival, setArrival, travelDate, setTravelDate, passengers, setPassengers, onProceedToSeats }) => {
...
const SeatSelectionScreen = ({ onBack, departure, arrival, travelDate, busSeats, selectedSeats, handleSeatSelect, passengers, totalPrice, onProceedToPayment }) => (
    <div>
      ...
      <div className="p-4 bg-gray-50 pb-40">
        <div className="bg-white p-3 rounded-lg shadow-sm mb-4 text-center">
            ...
            <p className="text-sm text-gray-600">{new Date(travelDate).toDateString()}</p>
        </div>
...
const PaymentScreen = ({ onBack, passengerName, departure, arrival, selectedSeats, totalPrice, phoneNumber, setPhoneNumber, isVerified, handleVerifyPhone, paymentMethod, setPaymentMethod, onConfirmBooking }) => (
    <div>
...
const ConfirmationScreen = ({ departure, arrival, passengerName, travelDate, selectedSeats, phoneNumber, totalPrice, onNewBooking }) => (
...
export default function App() {
  ...
  }, [departure, arrival]); // Rerun when departure changes
    ...
    switch (screen) {
      ...
      case 'seats':
        ...
        return <SeatSelectionScreen 
            ...
            departure={departure} arrival={arrival} travelDate={travelDate}
            busSeats={busSeats}
